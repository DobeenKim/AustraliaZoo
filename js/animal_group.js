function shortSummary(image, name, description, food, group) {
  (this.image = image),
    (this.name = name),
...
let fullNeckedLizard = new shortSummary(
  "",
  "Full-necked lizard",
...
const animalTab = document.querySelector(".welcome-hero-section");
animalTab.innerHTML = echidna.name;
